...
#read in county income data
income_PA<-read.csv("./Data/Raw/PA_income_per_county.csv", header = TRUE)
#join county income and county shape file
PA_county_income<-left_join(counties_sf, income_PA, by = c("County"))
```
