...
```{r time_series-data-wrangling1,echo=FALSE}
...
```{r spatial analysis 2010.2, echo=FALSE, fig.cap="2010 Mean Lead Levels Across Pennsylvania",fig.align='left',fig.height = 8, fig.width = 10}
ggplot() + 
...
```{r spatial-analysis 2010.3, echo=FALSE, fig.cap="2010 Max Lead Levels over .15 (µg/m3)",fig.align='left',fig.height = 8, fig.width = 10}
...
```{r spatial analysis 2015.4, echo=FALSE, fig.cap="2015 Mean Lead Levels Across Pennsylvania", fig.align='left',fig.height = 8, fig.width = 10}
#Reduce our data to just one record for each location, computing mean and max daily values 
...
```{r spatial analysis 2015.5, echo=FALSE, fig.cap="2015 Mean Lead Levels Across Pennsylvania"}
ggplot() + 
...
```{r spatial analysis 2015.6, echo=FALSE, fig.cap="2015 Max Lead Levels over .15 (µg/m3)"}
ggplot() + 
  geom_sf(data=PA_county_2014,aes(fill = meanPCI),alpha=0.3) + 
  scale_fill_gradient2(low="red",high="blue", midpoint = 30000, breaks=c(18000,30000, 40000)) +
  labs(fill="Per Capita
...
```{r spatial analysis 2020.1, echo=FALSE,fig.cap="2020 Mean Lead Levels Across Pennsylvania", fig.align='left',fig.height = 8, fig.width = 10}
#Reduce our data to just one record for each location, computing mean and max daily values 
...
```{r spatial analysis 2020.2, echo=FALSE, fig.cap="2020 Mean Lead Levels Across Pennsylvania", fig.align='left',fig.height = 8, fig.width = 10}
ggplot() + 
...
```{r spatial analysis 2020.3, echo=FALSE, fig.cap="2020 Max Lead Levels over .15 (µg/m3)",fig.align='left',fig.height = 8, fig.width = 10}
ggplot() + 
  geom_sf(data=PA_county_2018,aes(fill = meanPCI),alpha=0.3) + 
  scale_fill_gradient2(low="red",high="blue", midpoint = 35000, breaks=c(21000,35000, 47000)) +
  labs(fill="Per Capita
