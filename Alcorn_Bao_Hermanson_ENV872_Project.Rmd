...
model6 <- lm(formula = Percent_.5 ~ number_metal_plants + log_metal+ log_incinerate + meanPCI + meanPOV+    number_incinerators + number_airports + log_PCI + quadPOV, data = i_a_m_b_join) # plugged in every variable and then ran through "step" function , which produced model 7 
summary(model5)
step(model6) 
#step function 
