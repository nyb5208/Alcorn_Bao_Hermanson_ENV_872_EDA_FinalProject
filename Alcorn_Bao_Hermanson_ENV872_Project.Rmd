...
Scranton.msa.Pb.cleaned <-Scranton.msa.Pb %>%
  mutate(Daily.Mean.Pb.Concentration.clean=zoo::na.spline(Daily.Mean.Pb.Concentration))
Scranton.msa.Pb.cleaned
#Allentown-Bethlehem-Easton
#data runs from July 2010 to December 2020
Allentown.days <-as.data.frame(seq(ymd("2012-07-01"), ymd("2020-12-31"),by="days"))
