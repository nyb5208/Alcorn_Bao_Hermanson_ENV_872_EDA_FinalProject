...
```{r spatial analysis 2010, echo = false}
ggplot() + 
...
```{r spatial analysis 2015, echo=FALSE}
ggplot() + 
...
```{r spatial analysis 2020, echo=FALSE}
ggplot() + 
